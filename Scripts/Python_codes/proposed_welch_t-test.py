...
def main():
    ...
    print("\n========================================")
    print("FINAL SCA STATUS (N=1024 -PROPOSEDDESIGN WITHOUT MASKING)")
    print("========================================")
    if max_abs_t_val > THRESHOLD:
        print(f">>> STATUS: 🔴 VULNERABLE (Leakage Detected, |t| > {THRESHOLD})")
        print("    The  logic is failing to completely hide the key activity.")
    else:
    ...
    plt.title('Welch\'s t-test Leakage Assessment\nLTE_PROPOSED(N=1024)', fontsize=14, fontweight='bold')
    ...
    plot_filename = os.path.join(save_dir, "TVLA_SCA_PROPOSED Plot_N1024.png")
